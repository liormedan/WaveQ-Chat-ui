...
export const CompareIcon = ({ size = 16 }: { size?: number }) => {
  return (
    ...
    >
      <path
        d="M2 2H6V6H2V2ZM10 2H14V6H10V2ZM2 10H6V14H2V10ZM10 10H14V14H10V10ZM3 3V5H5V3H3ZM11 3V5H13V3H11ZM3 11V13H5V11H3ZM11 11V13H13V11H11Z"
        fill="currentColor"
      />
    </svg>
  );
...
export const WifiIcon = ({ size = 16 }: { size?: number }) => (
  ...
  >
    <path
      d="M2.5 8C4.5 6 7.5 6 9.5 8M1 6C3.5 3.5 7.5 3.5 10 6M0.5 4C3.5 1 8.5 1 11.5 4"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const WifiOffIcon = ({ size = 16 }: { size?: number }) => (
  ...
  >
    <path
      d="M2.5 8C4.5 6 7.5 6 9.5 8M1 6C3.5 3.5 7.5 3.5 10 6M0.5 4C3.5 1 8.5 1 11.5 4M1.5 1.5L14.5 14.5"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const ChartIcon = ({ size = 16 }: { size?: number }) => (
  ...
  >
    <path
      d="M3 13V7M7 13V3M11 13V9M15 13V5"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const SyncIcon = ({ size = 16 }: { size?: number }) => (
  <svg
    height={size}
    strokeLinejoin="round"
    viewBox="0 0 16 16"
  ...
  >
    <path
      d="M1 4V10C1 11.1046 1.89543 12 3 12H13M15 12L13 10M15 12L13 14M15 12V6C15 4.89543 14.1046 4 13 4H3M1 4L3 2M1 4L3 6"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const ListIcon = ({ size = 16 }: { size?: number }) => (
  ...
  >
    <path
      d="M3 6H13M3 10H13M3 14H13M3 2H13"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinecap="round"
      strokeLinejoin="round"
